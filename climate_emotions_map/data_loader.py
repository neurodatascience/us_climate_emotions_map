...
Example: After importing SURVEY_DATA in another script, the dataframe for the opinions_party.tsv data file can be accessed with SURVEY_DATA["opinions_party.tsv"].
"""
